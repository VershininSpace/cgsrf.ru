...
class User extends UserModel
{
	...
	public $appends = ['phone_list', 'total_cost', 'purchases', 'user_datas'];

	public $belongsToMany = [
		'groups' => [Group::class, 'table' => 'lovata_buddies_users_groups', 'key' => 'user_id'],
		// 'products' => [
		// 	'Chronos\App\Models\Product',
		...
		'roles' => [
			'Chronos\App\Models\Role',
			'table' => 'chronos_app_roles_users',
			'key' => 'user_id',
			'otherKey' => 'role_id',
			'pivot' => ['status', 'payment_id', 'payment_at', 'paid', 'role_id', 'user_id', 'pay_url', 'accepted'],
		]
	];
	...
	public $hasMany = [
		...
		// 'product_users' => 'Chronos\App\Models\ProductUser',
		'reqmoneys' => 'Chronos\App\Models\Reqmoney'
		/*'fr_transactions' => [
			'Chronos\App\Models\Transaction', 'key' => 'id', 'otherKey' => 'from_user'
		]*/
	];
    ...
    {
        return $this->hasOne('Lovata\Buddies\Models\User', 'id', 'parent_id');
    }

	public function childrens()
	{
		return $this->children()->with(['childrens', 'products_buy', 'parent_user']);
	...
	public function getTotalCostAttribute()
	{
		...
		return number_format($transactions->sum('total'), 0, '', ' ');
	}

	public function getUserDatasAttribute()
	{
