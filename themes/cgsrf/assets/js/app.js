...
alpinejs__WEBPACK_IMPORTED_MODULE_1__["default"].data('region_changer', function () {
  return {
    region: null,
    toggle: function toggle() {
      ...
      oc_request__WEBPACK_IMPORTED_MODULE_0__["default"].sendData('onSwitchRegion', {
        ...
        success: function success() {
          _this.$refs.selected.innerText = _this.$el.dataset.name;
    ...
    submit: function submit(event) {
      ...
      oc_request__WEBPACK_IMPORTED_MODULE_0__["default"].sendForm(event.target, 'onSaveReview', {
        success: function success(res) {
          _this2.message = 'Ваш отзыв успешно отправлен!';
          _this2.show = true;
          _this2.show_step = true;
          _this2.form_hidden = false, //jumpto('reviews-links');
...
var swiper = new swiper__WEBPACK_IMPORTED_MODULE_3__["default"]('.swiper-docs-ji', {
  loop: true,
  slidesPerView: 1,
...
var swiper_ado = new swiper__WEBPACK_IMPORTED_MODULE_3__["default"]('.swiper-docs-ado', {
  loop: true,
  slidesPerView: 1,
  modules: [swiper__WEBPACK_IMPORTED_MODULE_3__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_3__.Pagination],
  navigation: {
...
var swiper_eco = new swiper__WEBPACK_IMPORTED_MODULE_3__["default"]('.swiper-docs-eco', {
  loop: true,
  slidesPerView: 1,
  modules: [swiper__WEBPACK_IMPORTED_MODULE_3__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_3__.Pagination],
  navigation: {
...
/***/ "./themes/cgsrf/src/css/styles.css":
/*!*****************************************!*\
  !*** ./themes/cgsrf/src/css/styles.css ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/oc-request/src/oc-handle-response.js":
/*!***********************************************************!*\
  !*** ./node_modules/oc-request/src/oc-handle-response.js ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "completeFunc": () => (/* binding */ completeFunc),
/* harmony export */   "errorFunc": () => (/* binding */ errorFunc),
/* harmony export */   "handleResponse": () => (/* binding */ handleResponse)
/* harmony export */ });
/* harmony import */ var _oc_update_dom__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./oc-update-dom */ "./node_modules/oc-request/src/oc-update-dom.js");
...
const initUpdating = (data, response) => {
  const updateDOM = new _oc_update_dom__WEBPACK_IMPORTED_MODULE_0__["default"](data, response);

  updateDOM.update();
};

const errorFunc = (error = {}, options = {}) => {
  if (options.error) {
    options.error(error);
  }
};
...
const completeFunc = (response = {}, options = {}) => {
...
const handleResponse = (response, options, globalOptions) => {
  ...
  if (globalOptions.loading) {
    _oc_update_dom__WEBPACK_IMPORTED_MODULE_0__["default"].hide(options.loading);
  }
...
/***/ "./node_modules/oc-request/src/oc-parse-options.js":
/*!*********************************************************!*\
  !*** ./node_modules/oc-request/src/oc-parse-options.js ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ OCparseOptions)
/* harmony export */ });
/* harmony import */ var _oc_request_message__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./oc-request-message */ "./node_modules/oc-request/src/oc-request-message.js");
/**
...
class OCparseOptions {
  constructor(handler, options = {}) {
    if (handler === undefined) {
      this.constructor.showError(_oc_request_message__WEBPACK_IMPORTED_MODULE_0__["default"].handlerUndefined);
    }

    if (!handler.match(/^(?:\w+:{2})?on*/)) {
      this.constructor.showError(_oc_request_message__WEBPACK_IMPORTED_MODULE_0__["default"].HandlerNameInvalid);
    }
  ...
  extractPartials(obUpdate = {}) {
    if (obUpdate.toString() !== '[object Object]') {
      this.constructor.showError(_oc_request_message__WEBPACK_IMPORTED_MODULE_0__["default"].updateIsObject);
    }
...
/***/ "./node_modules/oc-request/src/oc-request-message.js":
/*!***********************************************************!*\
  !*** ./node_modules/oc-request/src/oc-request-message.js ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  handlerUndefined: 'The request handler name is not specified.',
  HandlerNameInvalid: 'Invalid handler name. The correct handler name format is: "onEvent".',
  updateIsObject: '"Update" option must be object{}',
...
/***/ "./node_modules/oc-request/src/oc-request.js":
/*!***************************************************!*\
  !*** ./node_modules/oc-request/src/oc-request.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _oc_parse_options__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./oc-parse-options */ "./node_modules/oc-request/src/oc-parse-options.js");
/* harmony import */ var _oc_request_message__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./oc-request-message */ "./node_modules/oc-request/src/oc-request-message.js");
/* harmony import */ var _oc_update_dom__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./oc-update-dom */ "./node_modules/oc-request/src/oc-update-dom.js");
/* harmony import */ var _oc_handle_response__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./oc-handle-response */ "./node_modules/oc-request/src/oc-handle-response.js");
/**
 * @author  Uladzimir Ambrazhey, <uladzimir.ambrazhey@gmail.com>
 */
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (new class OCRequest {
  constructor() {
  ...
  sendData(handler, options) {
    ...
    promisedXHR(xhr, data)
      .then(
        response => (0,_oc_handle_response__WEBPACK_IMPORTED_MODULE_3__.handleResponse)(response, options, this.obOptions),
        error => (0,_oc_handle_response__WEBPACK_IMPORTED_MODULE_3__.errorFunc)(error, this.obOptions),
      )
      .then(complete => (0,_oc_handle_response__WEBPACK_IMPORTED_MODULE_3__.completeFunc)(this.obResponseStore, this.obOptions, complete));
  }
  ...
  static promisificationRequest(obRequest, data, isString = false) {
    return new Promise((resolve, reject, complete) => {
      ...
      xhr.addEventListener('error', () => {
        reject(new Error(_oc_request_message__WEBPACK_IMPORTED_MODULE_1__["default"].requestError));
      });
  ...
  requestPreparing(handler, options, isFormData = false) {
    ...
    const parseOptionsInstance = new _oc_parse_options__WEBPACK_IMPORTED_MODULE_0__["default"](handler, options);
    ...
    if (options.loading) {
      _oc_update_dom__WEBPACK_IMPORTED_MODULE_2__["default"].show(options.loading);
    }
...
/***/ "./node_modules/oc-request/src/oc-update-dom.js":
/*!******************************************************!*\
  !*** ./node_modules/oc-request/src/oc-update-dom.js ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ OCUpdateDOM)
/* harmony export */ });
class OCUpdateDOM {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkgazprom_loc"] = self["webpackChunkgazprom_loc"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["css/styles"], () => (__webpack_require__("./themes/cgsrf/src/js/app.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/styles"], () => (__webpack_require__("./themes/cgsrf/src/css/styles.css")))
